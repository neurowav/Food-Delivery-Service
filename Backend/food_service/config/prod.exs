...
config :food_service, FoodServiceWeb.Endpoint,
  ...
  http: [port: 4000],
  url: [host: System.get_env("APPLICATION_HOST"), scheme: "https", port: "443"],
...
config :food_service, FoodServiceWeb.Endpoint, secret_key_base: System.get_env("SECRET_KEY_BASE")
